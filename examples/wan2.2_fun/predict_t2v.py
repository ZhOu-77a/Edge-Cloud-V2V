...
# TeaCache config
enable_teacache     = False   # True 暂时先关闭
...
# Riflex config
enable_riflex       = False  # set True when handle long video
...
pipeline = Wan2_2FunInpaintPipeline(
    transformer=transformer, # <Wan2_2Transformer3DModel>
    transformer_2=transformer_2,  # <Wan2_2Transformer3DModel>
    vae=vae, # <AutoencoderKLWan>
    tokenizer=tokenizer, 
    text_encoder=text_encoder,
    scheduler=scheduler,  # <FlowMatchEulerDiscreteScheduler, len() = 1000>
)
'''
